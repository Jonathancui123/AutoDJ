...
module.exports = function (app, getIOInstance) {
    ...
    // Follow a playlist
    router.put('/followPlaylist/:playlistId', async (req, res) => {
        console.log(`* /followPlaylist/${req.params.playlistId} called`);
        const retrievedUserData = await dbMethods.getUserInfo(req.session.userData.id);
        const accessToken = retrievedUserData.accessToken;
    ...
    router.get('/checkFollowPlaylist/:playlistId', async (req, res) => {
        console.log(`* /checkFollowPlaylist/${req.params.playlistId} called`);
        console.log(req.session.userData);
        var result = await queueMethods.checkFollowPlaylist(req.params.playlistId, req.session.userData.spotifyId, req.session.userData.access_token);
